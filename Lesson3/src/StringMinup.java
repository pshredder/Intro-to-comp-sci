...
public class StringMinup {
	...
	public static void main(String[] args) {
		...
		int x = z.substring(0,19).length() - 10;
		...
		String m = "jim, Jacky, johnny, Jill";
		int s = m.substring(0,3).toLowerCase().length(); 
int t = m.substring(6,10).toUpperCase().length();
int j = m.substring(12,18).toLowerCase().length();
int y = m.substring(19,23).toLowerCase().length();
System.out.println(m.substring(0,4).toLowerCase() + "\\" + s);
System.out.println( m.substring(6,11).toUpperCase() + "\\" + t);
System.out.println( m.substring(11,17).toLowerCase() + "\\" + j);
System.out.println(m.substring(18,25).toLowerCase() + "\\" + y);
	}
